...
getting_last_test() ->
  ...
  {{{2000,1,20},{1,1,1}}, "PM-2.5", 100} = pollution:getLastMeasurment("AAB", "PM-2.5", Tab1).

getting_last_2_test() ->
  Tab = createMonitorWithMultipleStations(null, [{"AA", {1,2}}, {"AAB", {1,3}}], 0),
  Tab1 = createMultipleMeasurements(Tab, [{"AA", {{2000,1,12},{1,11,1}}, "PM-2.5", 50},{"AA", {{2000,2,15},{1,1,1}}, "PM-2.5", 10},{"AA", {{2000, 2, 12},{1,1,1}}, "PM-2.5", 100},{"AAB", {{2000,1,20},{1,1,1}}, "PM-2.5", 100}]),
  null = pollution:getLastMeasurment("AAB", "PM-10", Tab1).

getting_last_3_test() ->
  Tab = createMonitorWithMultipleStations(null, [{"AA", {1,2}}, {"AAB", {1,3}}], 0),
  Tab1 = createMultipleMeasurements(Tab, [{"AA", {{2000,1,12},{1,11,1}}, "PM-2.5", 50},{"AA", {{2000,2,15},{1,1,1}}, "PM-2.5", 10},{"AA", {{2000, 2, 12},{1,1,1}}, "PM-2.5", 100},{"AAB", {{2000,1,20},{1,1,1}}, "PM-2.5", 100}]),
  {{{2000,2,15},{1,1,1}},"PM-2.5",10} = pollution:getLastMeasurment("AA", "PM-2.5", Tab1).